...
btn_1 = Button(root, text="1", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('1'))

btn_2 = Button(root, text="2", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('2'))

btn_3 = Button(root, text="3", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('3'))

btn_4 = Button(root, text="4", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('4'))

btn_5 = Button(root, text="5", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('5'))

btn_6 = Button(root, text="6", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('6'))

btn_7 = Button(root, text="7", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('7'))

btn_8 = Button(root, text="8", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('8'))

btn_9 = Button(root, text="9", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('9'))

btn_0 = Button(root, text="0", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.numclick('0'))

btn_point = Button(root, text=".", padx=31, pady=15,bd=4,bg="#eff1f4", command=lambda: c.decimalClick())

btn_add = Button(root, text="+", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.DMAS_mod_Click('+'))

btn_sub = Button(root, text="-", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.DMAS_mod_Click('-'))

btn_mult = Button(root, text="x", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.DMAS_mod_Click('*'))

btn_div = Button(root, text="/", padx=30, pady=15,bd=4,bg="#eff1f4", command=lambda: c.DMAS_mod_Click('/'))

btn_sign = Button(root, text="+/-", padx=21, pady=15,bd=4,bg="#eff1f4", command=lambda: c.signClick())

btn_equals = Button(root, text="=", padx=30, pady=15,font=myfont,bd=4,bg='orange' ,command=lambda: c.equalpress())

btn_reciprocal = Button(root, text='x'+get_super('-1'), padx=21, pady=15,bd=4,bg="#eff1f4", command=lambda: c.rec_fact_click('r'))

btn_power = Button(root, text='x'+get_super('y'), padx=27, pady=15,bd=4,bg="#eff1f4", command=lambda: c.pow_pc_clicked('pow'))

btn_root = Button(root, text="√", padx=29, pady=15,bd=4,bg="#eff1f4", command=lambda: c.trig_log_root_click('r'))

btn_fact = Button(root, text="x!", padx=24, pady=15,bd=4,bg="#eff1f4", command=lambda: c.rec_fact_click('!'))

btn_permucombo = Button(root, text="nCr", padx=20, pady=15,bd=4,bg="#eff1f4", command=lambda: c.pow_pc_clicked('c'))

btn_random = Button(root, text="Ran#", padx=16, pady=15,bd=4,bg="#eff1f4", command=lambda: c.epiRanClick('Ran'))

btn_mod = Button(root, text="MOD", padx=21, pady=15,bd=4,bg="#eff1f4", command=lambda: c.DMAS_mod_Click('mod'))

btn_e = Button(root, text="e", padx=29, pady=15,bd=4,bg="#eff1f4", command=lambda: c.epiRanClick('e'))

btn_pi = Button(root, text="π", padx=29, pady=15,bd=4,bg="#eff1f4", command=lambda: c.epiRanClick('pi'))

btn_sin = Button(root, text="sin", padx=20, pady=15,bd=4,bg="#eff1f4", command=lambda: c.trig_log_root_click('s'))

btn_cos = Button(root, text="cos", padx=20, pady=15,bd=4,bg="#eff1f4", command=lambda: c.trig_log_root_click('c'))

btn_tan = Button(root, text="tan", padx=20, pady=15,bd=4,bg="#eff1f4", command=lambda: c.trig_log_root_click('t'))

btn_log10 = Button(root, text="log", padx=20, pady=15,bd=4,bg="#eff1f4", command=lambda: c.trig_log_root_click('g'))

btn_loge = Button(root, text="ln", padx=26, pady=15,bd=4,bg="#eff1f4", command=lambda: c.trig_log_root_click('n'))

btn_2nd = Button(root, text="2nd", padx=20, pady=15,bd=4,bg="#eff1f4", command=lambda: c.deg_2nd_click('2nd'))

btn_deg = Button(root, text="deg", padx=20, pady=15,bd=4,bg="#eff1f4", command=lambda: c.deg_2nd_click('deg'))

btn_ce = Button(root, text="CE", padx=26, pady=15,bd=4,bg="#eff1f4", command=lambda: c.CE())

btn_ac = Button(root, text="AC", padx=25, pady=15,bd=4,bg="#eff1f4", command=lambda: c.AC())
